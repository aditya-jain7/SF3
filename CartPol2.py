...
class CartPole:
    ...
    def __init__(self, visual=False):
        ...
        self.sim_steps = 50        # number of Euler integration steps to perform in one go 50/5
        self.delta_time = 0.05        # time step of the Euler integrator 0.2/2
        self.max_force = 20.
        self.gravity = 9.8
        self.cart_mass = 0.5
    ...
    def getState(self):
        return np.array([self.cart_location+5,self.cart_velocity+5,self.pole_angle+5,self.pole_velocity+5])
